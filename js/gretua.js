            ...
            if (this.responseText != "fim") {
                ...
                for (let i = 0; i < pubs[0].repeticoes; i++) {
                    ...
                    if (pubs[i].tipo == "pub") {
                        ...
                        div.innerHTML = '<div class="card pubfeed"> <div class="card-body"> <div class="row row-cols-auto justify-content-between align-items-center"> <div class="col"> <div class="infouser"> <img src="img/users/' + pubs[i].fperfil_user + '" class="userbubble"> <span class="utilizador">' + pubs[i].nome_user + '</span> </div> </div><div class="col infotime">' + tempo_str + '</div> </div> </div> ' + pubs[i].foto + ' <button class="btn btn-like"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16"> <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/> </svg> </button> <div class="card-body"> <h5 class="card-title">' + pubs[i].titulo + '</h5> <p class="card-text">' + pubs[i].texto + '</p> <div class="row"> <div class="col-auto pe-0"> <img src="img/users/' + pubs[i].fperfil_session + '" class="userbubble"> </div> <div class="col"> <form method="POST" action="sc_comentar.php?id=' + pubs[i].id_pub + '"> <input type="text" name="comentario" class="form-control comentar" id="exampleInputEmail1" placeholder="Comentar"> </form> </div> </div> </div> </div>'
                    } else if (pubs[i].tipo == "memoria") {
                        lastdata = pubs[i - 1].lastdata
                        div.innerHTML = '<div class="card memoriafeed"> <a href="memoria.php?memoria=' + pubs[i].id_memoria + '"><img src="img/eventos/' + pubs[i].foto + '" class="card-img-top" alt="..."> </a><div class="card-body pb-0"> <div class="row row-cols-auto justify-content-between align-items-end"> <div class="col"> <h3 class="card-title mb-0">' + pubs[i].nome_memoria + '</h3> </div><div class="pt-3 pb-2"> <p class="card-text">' + pubs[i].desc_curta + '</p> </div> </div> </div> <div class="pt-2"><a href="memoria.php?memoria=' + pubs[i].id_memoria + '" class="btn btn-memoriafeed">Ver Memória</a></div></div>'
                    } else {
                        lastdata = pubs[i - 1].lastdata
                        div.innerHTML = '<a class="aevento" href="evento.php?evento=' + pubs[i].id_evento + '"> <div class="eventoindex"> <div class="evento-card-degrade"></div> <img class="img-fluid img-evento" src="img/eventos/' + pubs[i].foto + '"> <div class="desc-evento container-fluid px-3"> <h6 class="top-right">' + pubs[i].nome_evento + '</h6> <div class="row"> <div class="col-auto text-cinza">' + pubs[i].desc_curta + '</div> <div class="col text-cinza text-end">' + pubs[i].tipo_evento + '</div> </div> </div> </a> </div> <div class="row pt-3 justify-content-between align-items-center"> <div class="col-auto"> <h4 class="mb-0 ps-2">' + pubs[i].pessoas + '</h4> </div> <div class="col-auto"> <a href="evento.php?evento=' + pubs[i].id_evento + '" class="btn btn-eventofeed">Ver Evento</a> </div> </div>';
                    }
